    ...
    <div className="agriculture-container">
      ...
      <div className="image-showcase">
        <div className="showcase-left">
          <img src="/images/RHS.png" alt="Farm demonstration" className="large-img" />
        </div>
        <div className="showcase-right">
          <img src="/images/kvk.jpeg" alt="Training session" />
          <img src="/images/field.png" alt="Laboratory work" />
          <img src="/images/boat.png" alt="Field visit" />
        </div>
      </div>
      ...
      <div className="contact-section">
        ...
        <div className="contact-content">
          ...
          <div className="contact-image">
            <img src="/images/boys.png" alt="KVK Building" />
          </div>
        </div>
      </div>
      <Footer/>
