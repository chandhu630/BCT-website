    ...
    <div className="tribal-education">
      ...
      <div className="hero-section">
        ...
        <div className="hero-image">
          <img src="/images/boys.png" alt="Tribal Education" />
        </div>
      </div>
      ...
      <div className="partners-section">
        ...
        <div className="partners-grid">
          <img src="/images/RHS.png" alt="Sikshana Foundation" />
          <img src="/images/tribalShool.png" alt="Government of AP" />
          <img src="/images/boys.png" alt="Vibha Inc" />
        </div>
      </div>
      <Footer/>
    </div>
