    ...
    <div className="smart-programs">
      ...
      <div className="hero-section">
        <div className="hero-content">
          <img src="/images/boys.png" alt="BCT TMF Logo" className="main-logo" />
      ...
      <div className="centers-overview">
        ...
        <div className="centers-content">
          ...
          <img src="/images/group.png" alt="SMART Center" className="center-image" />
        </div>
      </div>
      ...
      <div className="origin-section">
        <div className="origin-content">
          <img src="/images/field.png" alt="Students Learning" className="origin-image" />
      ...
      <div className="program-details">
        ...
        <div className="details-content">
          ...
          <img src="/images/kvk.jpeg" alt="Training Session" className="details-image" />
        </div>
      </div>
      ...
      <div className="key-features">
        ...
        <div className="features-grid">
          <div className="feature-card">
            <img src="/images/tribalShool.png" alt="Technical Training" className="feature-image" />
