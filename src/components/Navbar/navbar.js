...
//             >
//               <span>
//                 Education <i className="fas fa-chevron-right" style={{ fontSize: "8px" }}></i>
//               </span>
//               {showEducationSubMenu && (
//                 <ul className="sub-dropdown">
//                   <li>
//                     <Link to="/trust-areas/education/rhs">Residential High School</Link>
//                   </li>
//                   <li>
//                     <Link to="/trust-areas/education/tribalEd">Tribal Primary Education</Link>
//                   </li>
//                 </ul>
//               )}
//             </p>
...
//             >
//               <span>
//                 Skill Development <i className="fas fa-chevron-right" style={{ fontSize: "8px" }}></i>
//               </span>
//               {showSkillDevSubMenu && (
//                 <ul className="sub-dropdown">
//                   <li>
//                     <Link to="/trust-areas/skill-dev/iti">ITI</Link>
//                   </li>
//                   <li>
//                     <Link to="/trust-areas/skill-dev/smart-centers">Smart Centers</Link>
//                   </li>
//                 </ul>
//               )}
//             </p>
//             <p>
//               <Link to="/trust-areas/pwds">Rehab of PWDs</Link>
//             </p>
//             <p>
//               <Link to="/trust-areas/agri">Agriculture</Link>
//             </p>
//             <p>
//               <Link to="/trust-areas/community">Community Organization</Link>
//             </p>
//           </div>
//         </li>
