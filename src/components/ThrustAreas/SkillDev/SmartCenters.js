    ...
    <div>
        ...
        <div style={{marginTop:"30px"}} className='AboutIt_smart'>
          <div className='ItImage_smart'>
            <img className='realItimage_smart' src='/smartiti/handsit.jpeg' alt='' />
          </div>
        ...
        <div className='ITGallery_smart' style={{marginTop:"30px", marginBottom:"30px"}} >
          ...
          <div className='itprograms_smart'>
            <div className='ITDiv_smart'><img className='ItPro_img_smart'  src='/smartiti/place.jpeg' alt='' /></div>
          ...
          <li className='ListIT_smart'>Students learn IT enabled services and Customer Relations & Sales.</li></div>
            <div className='ITDiv_smart'><img className='ItPro_img_smart' src='/smartiti/cel.jpeg' alt='' /></div>
          ...
          <div className='itprograms_smart'>
            ...
            <div className='ITDiv_smart'><img className='ItPro_img_smart' src='/smartiti/softsma.jpeg' alt='' /></div>
