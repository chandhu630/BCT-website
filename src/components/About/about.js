      ...
      <div className="about-us-content">
        <div className="text-content">
          ...
          <div className='flexButtons'>
            ...
            <button  className="timelinecolor"><Link className="linknone" to="/timeline">TimeLine </Link></button>
            <button  className="learn-more"><Link className="linknone" to="/team">The Team </Link></button>
